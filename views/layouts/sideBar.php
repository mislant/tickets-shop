...
<? if (!Yii::$app->user->isGuest): ?>
    <nav class="navbar navbar-inverse sidebar" role="navigation"
         style="width:16rem;margin:0 auto;position: fixed;box-shadow: -1px 1px 6px 0px #b5b5b5;">
        <div class="navbar-header">
            <ul class="nav navbar-nav" style="display: flex; flex-direction: column;padding:0.5rem;" ;>
                ...
                <? elseif (Yii::$app->user->can('manager')): ?>
                    ...
                    <li><a href="/user/show-manager-tools">Мои мероприятия<span style="font-size:16px;"
